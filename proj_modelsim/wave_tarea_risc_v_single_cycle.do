...
add wave -noupdate -group IMMD /RISC_V_Single_Cycle_TB/DUV/IMM_UNIT/op_i
add wave -noupdate -group IMMD /RISC_V_Single_Cycle_TB/DUV/IMM_UNIT/Instruction_bus_i
add wave -noupdate -group IMMD /RISC_V_Single_Cycle_TB/DUV/IMM_UNIT/Immediate_o
...
add wave -noupdate -expand -group t2 /RISC_V_Single_Cycle_TB/DUV/REGISTER_FILE_UNIT/Register_t2/DataOutput
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 2} {11 ns} 0}
